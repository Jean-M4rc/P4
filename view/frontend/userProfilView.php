...
=======
		...
		<div class="jumbotron mb-3">
			<h3 class="display-7">Renseigner les champs à modifier</h3>
			<hr class="my-4">
			<form role="form" method="post" data-toggle="validator" enctype="multipart/form-data" action="<?= $GLOBALS['url'] ?>?action=updateProfil">
				<fieldset>
					<!-- Update du pseudo -->
					<div class="form-group">
						<label for="pseudo">Votre pseudo</label>
...
<div class="modal fade" id="signOutModal" tabindex="-1" role="dialog" aria-labelledby="signOutModalCenter" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form method="post" action="<?= $GLOBALS['url'] ?>?action=signOut"> 
				<fieldset>
