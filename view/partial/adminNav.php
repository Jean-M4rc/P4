...
<<<<<<< HEAD
	<a class="navbar-brand" href="http://jeanforteroche.code-one.fr/index.php">Jérôme Forteroche | <i class="fas fa-home"></i></a>
=======
...
>>>>>>> poo_transform
	...
	<div class="collapse navbar-collapse justify-content-end" id="navbarColor03">
		...
		<div class="btngroup">
<<<<<<< HEAD
			<a href='http://jeanforteroche.code-one.fr/index.php?action=pandOra&target=commentsEdit'><button class="btn btn-outline-warning mr-1 my-1" type="button"><i class="fas fa-quote-right"></i> Commentaires</button></a>
=======
...
?>
<<<<<<< HEAD
			<a href='http://jeanforteroche.code-one.fr/index.php?action=pandOra&target=postCreate'><button class="btn btn-outline-primary mr-1 my-1" type="button"><i class="far fa-file-alt"></i> Ecrire</button></a>
			<a href='http://jeanforteroche.code-one.fr/index.php?action=pandOra&target=postsEdit'><button class="btn btn-outline-success mr-1 my-1" type="button"><i class="fas fa-book"></i> Récits</button></a>
			<a href='http://jeanforteroche.code-one.fr/index.php?action=pandOra&target=usersEdit'><button class="btn btn-outline-info mr-1 my-1" type="button"><i class="fas fa-users"></i> Abonnés</button></a>
=======
