<nav class="navbar navbar-expand-xl navbar-light bg-light">
	...
	<div class="collapse navbar-collapse justify-content-end" id="navbarColor03">
		...
		<div class="btngroup">
			...
			<a href='http://localhost/P4/index.php?action=pandOra&target=goldbookEdit'><button class="btn btn-outline-primary mr-1 my-1" type="button"><i class="fas fa-chess-queen"></i> Livre d'Or</button></a>
