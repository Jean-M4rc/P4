...
<?php
	...
	{
?>
			<a href='http://localhost/P4/index.php?action=pandOra&target=postCreate'><button class="btn btn-outline-primary mr-1 my-1" type="button"><i class="far fa-file-alt"></i> Ecrire</button></a>
